...
global.botname = process.env.BotName || "ℂ𝕪𝕓𝕖𝕣𝕥𝕣𝕠𝕟" 
global.author = process.env.Author || "@PikaBotz" 
global.packname = process.env.PackName || "ℂ𝕪𝕓𝕖𝕣𝕥𝕣𝕠𝕟 v2 MD" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© ℂ𝕪𝕓𝕖𝕣𝕥𝕣𝕠𝕟Bot" 
...
module.exports = {
  botname: process.env.BotName || "ℂ𝕪𝕓𝕖𝕣𝕥𝕣𝕠𝕟", 
  author: process.env.Author || "@minura",
  packname: process.env.PackName || "ℂ𝕪𝕓𝕖𝕣𝕥𝕣𝕠𝕟 v2 MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© ℂ𝕪𝕓𝕖𝕣𝕥𝕣𝕠𝕟 Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "mc",
  ownernumber: process.env.Owner_Number || "94 74 8484 955",
